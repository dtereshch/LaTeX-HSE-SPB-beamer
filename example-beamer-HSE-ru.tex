...
% Корректировки для Санкт-Петербурга и Ubuntu - Дмитрий Терещенко
...
\usepackage[no-math]{fontspec}      % подготавливает загрузку шрифтов Open Type, True Type и др.
	...
	\usefonttheme[onlymath]{serif}  % other font for equation
	\setmonofont{Liberation Mono} % вместо Courier New
\usepackage{mathspec}
